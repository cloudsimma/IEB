...
CreateMap.put("Street",records.get("Street"));
...
info CreateMap;
otherParams = Map();
response = zoho.creator.updateRecord("inspectorempirebuilder","ieb","Leads_Report",records.get("Zoho_Creator_ID").toLong(),CreateMap,otherParams,"zohocreator");
info response;
